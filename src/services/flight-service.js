...
async function getFlight(id){
  try {
    ...
    if(error.statusCode == StatusCodes.NOT_FOUND){
      throw new AppError('The flight you requested is not prestent', error.statusCode);
    }
    throw new AppError('Cannot fetch a flight data', StatusCodes.INTERNAL_SERVER_ERROR);
  }
}
